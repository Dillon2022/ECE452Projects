...
# Controlling the Alphabot
# TODO: you need to adjust the motor and operation time
def turn90(Ab):
    for i in range(10):
        left(Ab)
        time.sleep(0.5)
...
while cap.isOpened():
    ...
    if ret:
        ...
        if len(corners)!=0: # if aruco marker detected
            ...
            # TODO: State 0. How should you set the goal points based on the moment when the robot 
            #       detects a marker?
                state_flag = 1
                rot_flag = 0
            ...
            # TODO: State 1. How should the robot move based on the information above?
                if cur_dist :
            ...
            # TODO:How should the robot move when it misses the marker?
            if rot_flag == 1:
...
# Turn off the Alphabot and camera
Ab.stop()
cap.release()
